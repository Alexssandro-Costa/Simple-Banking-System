package com.bankingSystem.repository.dao;

import com.bankingSystem.repository.DataBaseSource;
import com.bankingSystem.exceptions.AccountNotFoundException;
import com.bankingSystem.exceptions.DatabaseException;
...
/**
 * Classe que implementa métodos de Inserção, atualização, Busca e exclusão de dados
 * @author Alexssandro
 * @since release 1
 * @version 2.0
 */
